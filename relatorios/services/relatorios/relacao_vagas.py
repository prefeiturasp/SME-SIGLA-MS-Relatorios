                ...
                for dre_codigo, vagas_list in dres.items():
                    if vagas_list:
                        ...
                        for vaga in vagas_list:
                            # Vagas Originais: usar utilizadas se existir, senão usar o valor original
        ...
        try:
            ...
            for cargo in cargos_list:
                ...
                for dre in cargo.get('dres', []):
                    ...
                    # Criar tabela
                    headers = ['Tipo de unidade', 'Código EOL', 'Vagas Definitivas Originais', 
                              'Vagas Definitivas Atuais', 'Vagas Precárias Originais', 'Vagas Precárias Atuais']
