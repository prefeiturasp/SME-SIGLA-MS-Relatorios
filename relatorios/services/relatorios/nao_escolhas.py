...
class NaoEscolhas(RelatorioBase):
    ...
    def render_to_xls(self, cargos_list, cabecalho, filename='relatorio_nao_escolhas.xlsx'):
        """
    ...
    def render_to_docx(self, cargos_list, cabecalho, filename='relatorio_nao_escolhas.docx'):
        """
