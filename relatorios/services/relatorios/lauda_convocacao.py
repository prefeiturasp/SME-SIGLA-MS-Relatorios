...
class LaudaConvocacao(RelatorioBase):
    ...
    def render_to_docx(
        ...
        context,
        texto_final,
        filename="lauda_convocacao.docx",
    ):
        """
    ...
    def _render_xls(
        self, cargos_list, context=None, filename="lauda_convocacao.xlsx"
    ):
        """
            ...
            try:
                ...
                if image_path:
                    ...
                    try:
                        ...
                        pass
                    # Ancorar próximo ao centro (planilha com 6 colunas -> coluna C aparenta centralizada)  # noqa: E501
                    ws.add_image(img, "C1")
