...
class SumulaReconvocacao(RelatorioBase):
    ...
    def gerar(self, processo_uuid: str, request, formato: str = 'html', cabecalho: str = ''):
        ...
        # Buscar escolhas com situação 'reconvocacao' usando os UUIDs dos ConcursoCandidato
        try:
    ...
    def render_to_xls(self, cargos_list, cabecalho, filename='relatorio_reconvocacao.xlsx'):
        """
    ...
    def render_to_docx(self, cargos_list, cabecalho, filename='relatorio_reconvocacao.docx'):
        """
