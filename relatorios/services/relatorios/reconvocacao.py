...
class SumulaReconvocacao(RelatorioBase):
    ...
    def render_to_xls(self, context={}, filename='relatorio_reconvocacao.xlsx'):
        """
    ...
    def render_to_docx(self, cargos_list, cabecalho, texto_final, filename='relatorio_reconvocacao.docx'):
        """
