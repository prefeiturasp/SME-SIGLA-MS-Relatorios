...
class SumulaReconvocacao(RelatorioBase):
    ...
    def gerar(
        ...
        **kwargs,
        ...
        # Buscar escolhas com situação 'reconvocacao' usando os UUIDs dos ConcursoCandidato  # noqa: E501
        try:
            escolhas_data = (
    ...
    def render_to_xls(
        self, context=None, filename="relatorio_reconvocacao.xlsx"
    ):
        """
    ...
    def render_to_docx(
        ...
        cabecalho,
        texto_final,
        filename="relatorio_reconvocacao.docx",
    ):
        """
