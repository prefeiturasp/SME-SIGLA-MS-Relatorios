...
class RelatorioViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if (
            ...
            format_param == "docx"
            or format_param == "doc"
            or "application/vnd.openxmlformats-officedocument.wordprocessingml.document"  # noqa: E501
            in accept_header
        ):
            formato = "docx"
        else:
        ...
        try:
            ...
            try:
                ...
                logger.info(
                    "Relatório salvo no banco de dados - tipo: %s, usuario: %s",  # noqa: E501
                    tipo_relatorio,
                    usuario,
                )
            except Exception as exc:
                logger.error(
                    "Erro ao salvar relatório no banco de dados: %s",
                    exc,
                    exc_info=True,
                )
