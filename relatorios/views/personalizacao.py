...
class PersonalizacaoViewSet(mixins.ListModelMixin,
    ...
    def get_queryset(self):
        """Filtra por tipo se fornecido nos query params."""
    ...
    def list(self, request, *args, **kwargs):
        ...
        processo_uuid = request.query_params.get('processo_uuid', None)  # Aceito mas não usado
        
        if not tipo:
            return Response(
                {'detail': 'Parâmetro "tipo" é obrigatório.'},
