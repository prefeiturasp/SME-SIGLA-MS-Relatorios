...
class TestGerar:
    ...
    def test_gerar_docx_success(
        ...
        mock_response["Content-Disposition"] = (
            'attachment; filename="listagem_escolhas_dres_proc-123.docx"'
        )
        with patch.object(
            listagem_escolhas_dres_service,
            "render_to_docx",
        ...
        assert "docx" in response.get(
            "Content-Disposition", ""
        ) or "listagem" in response.get("Content-Disposition", "")
...
class TestRenderToXls:
    ...
    @patch(
        "relatorios.services.relatorios.listagem_escolhas_dres.OPENPYXL_AVAILABLE",
        False,
    )
...
class TestRenderToDocx:
    ...
    @patch(
        "relatorios.services.relatorios.listagem_escolhas_dres.DOCX_AVAILABLE",
        False,
    )
    ...
    @patch(
        "relatorios.services.relatorios.listagem_escolhas_dres.Document",
        create=True,
    )
    @patch(
        "relatorios.services.relatorios.listagem_escolhas_dres.Inches",
        create=True,
    )
    @patch(
        "relatorios.services.relatorios.listagem_escolhas_dres.Pt", create=True
    )
    @patch(
        "relatorios.services.relatorios.listagem_escolhas_dres.RGBColor",
        create=True,
    )
    @patch(
        "relatorios.services.relatorios.listagem_escolhas_dres.WD_ALIGN_PARAGRAPH",
        create=True,
    )
    @patch(
        "relatorios.services.relatorios.listagem_escolhas_dres.qn", create=True
    )
    @patch(
        "relatorios.services.relatorios.listagem_escolhas_dres.OxmlElement",
        create=True,
    )
    ...
    def test_render_to_docx_sem_cabecalho(
        ...
        mock_table.add_row.return_value.cells = [
