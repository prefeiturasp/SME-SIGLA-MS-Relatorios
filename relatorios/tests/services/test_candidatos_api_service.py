...
def test_buscar_habilitados_single_codigo(mock_get):
    ...
    mock_get.assert_called_once_with(
        ...
        params={'processo_uuid': 'proc1', 'ordering': 'ranking_escolha', 'codigo_cargo': '123'},
...
def test_buscar_candidatos_por_agendas_success_extracts_both_formats(monkeypatch):
    svc = _svc()
    # agenda 1 sem candidatos_uuids; agenda 2 com candidates em dict results; agenda 3 com list
