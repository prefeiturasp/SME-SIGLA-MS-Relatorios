...
class ConfiguracaoRelatorio(BaseModel):
    ...
    cabecalho_gabarito = models.TextField(verbose_name='Cabeçalho Gabarito', default='', blank=True)
    texto_final = models.TextField(verbose_name='Texto Final', default='', blank=True)
    cabecalho_capa_ata = models.TextField(verbose_name='Cabeçalho Capa da Ata', default='', blank=True)
