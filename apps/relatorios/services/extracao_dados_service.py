    ...
    def _montar_comparativo(
        ...
        indicadores = {
            ...
            "autorizacoes": cls._diferenca_absoluta(
                cls._obter_valor(concurso_antigo, "autorizacoes-publicadas"),
                cls._obter_valor(concurso_recente, "autorizacoes-publicadas"),
            ),
        }
        ...
        for chave in sorted(set(dres_antigo) | set(dres_recente)):
            ...
            dres_comparativo[chave] = {
                "escolhas": cls._diferenca_absoluta(escolhas_a, escolhas_r),
