...
@patch("relatorios.api.views.relatorios.RelatorioFactory.obter_relatorio")
def test_create_returns_xls_when_query_param_is_xls(
    mock_factory: Any, client: Any
) -> None:
...
@patch("relatorios.api.views.relatorios.RelatorioFactory.obter_relatorio")
def test_create_returns_pdf_when_query_param_pdf(
    mock_factory: Any, client: Any
) -> None:
...
@patch("relatorios.api.views.relatorios.RelatorioFactory.obter_relatorio")
def test_create_returns_docx_when_query_param_docx(
    mock_factory: Any, client: Any
) -> None:
...
@patch("relatorios.api.views.relatorios.RelatorioFactory.obter_relatorio")
def test_create_handles_cargo_obrigatorio_error(
    mock_factory: Any, client: Any
) -> None:
...
@patch(
    "relatorios.api.views.relatorios.RelatorioFactory.obter_relatorio",
...
@patch("relatorios.api.views.relatorios.RelatorioFactory.obter_relatorio")
def test_create_handles_generic_exception(
    mock_factory: Any, client: Any
) -> None:
